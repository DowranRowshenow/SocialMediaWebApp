from django.views.generic import View, ListView, FormView, CreateView, UpdateView, DetailView, DeleteView
...
class CreatePostView(CreateView):
    ...
    def form_valid(self, form):
        ...
        except Exception as e: return super().form_invalid(form)
